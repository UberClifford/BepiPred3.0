...
### STATICS PATHS ###
ROOT_DIR = Path.cwd()
ESM_EMBEDDINGS = ROOT_DIR / "../4ESMEncodePartitions/"
EPITOPE_ANNOTATIONS = ROOT_DIR / "../3DivideProteinsInto5Partitions/Results/bepipred3_all_annotations.fasta" 
CROSS_VALIDATION_SAVE_PATH = ROOT_DIR / "../6CrossValidationNonHomologyReduced"
CROSS_VALIDATION_SAVE_PATH_HOMOLOGY_REDUCED = ROOT_DIR / "../7CrossValidationHomologyReduced"
