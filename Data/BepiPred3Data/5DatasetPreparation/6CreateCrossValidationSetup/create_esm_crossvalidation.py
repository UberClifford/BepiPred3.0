...
### STATICS PATHS ###
ROOT_DIR = Path.cwd()
ESM_EMBEDDINGS = ROOT_DIR / "../5ESMEncodePartitions/"
EPITOPE_ANNOTATIONS = ROOT_DIR / "../4DivideProteinsInto5Partitions/Results/bepipred3_all_annotations.fasta" 
CROSS_VALIDATION_SAVE_PATH = ROOT_DIR / "../7CrossValidationNonHomologyReduced"
CROSS_VALIDATION_SAVE_PATH_HOMOLOGY_REDUCED = ROOT_DIR / "../8CrossValidationHomologyReduced"
...
CROSS_VALIDATION_SAVE_PATH_HOMOLOGY_REDUCED = CROSS_VALIDATION_SAVE_PATH_HOMOLOGY_REDUCED.resolve()
...
### NOT HOMOLOGY REDUCED DATASET ###

#load all partitions 
partition_1_esm_rep, partition_1_labels = get_esm_representations_and_labels(ESM_EMBEDDINGS / "Fold1", EPITOPE_ANNOTATIONS)
partition_2_esm_rep, partition_2_labels = get_esm_representations_and_labels(ESM_EMBEDDINGS /"Fold2", EPITOPE_ANNOTATIONS)
partition_3_esm_rep, partition_3_labels = get_esm_representations_and_labels(ESM_EMBEDDINGS /"Fold3", EPITOPE_ANNOTATIONS)
partition_4_esm_rep, partition_4_labels = get_esm_representations_and_labels(ESM_EMBEDDINGS /"Fold4", EPITOPE_ANNOTATIONS)
partition_5_esm_rep, partition_5_labels = get_esm_representations_and_labels(ESM_EMBEDDINGS /"Fold5", EPITOPE_ANNOTATIONS)
...
### HOMOLOGY REDUCED DATASET ###
cluster70id_rep_embeddings, cluster70id_rep_labels = get_esm_representations_and_labels(ESM_EMBEDDINGS / "ClusterId70Rep", EPITOPE_ANNOTATIONS)
crossvalidation_folds(cluster70id_rep_embeddings, cluster70id_rep_labels, 5, CROSS_VALIDATION_SAVE_PATH_HOMOLOGY_REDUCED)
#save same test data in this crossvalidation
save_data(test_esm_rep, test_labels, CROSS_VALIDATION_SAVE_PATH_HOMOLOGY_REDUCED, "test")
